...
Object_OpenedBigChest:
{
    ...
    ; ALTERNATE ENTRY POINT ; TODO: Get address.
    .fake
...
Object_PrisonBars:
{
    ...
    LDA $9B54, Y : STA $7E2002, X                : STA $7E200E, X
                                                   STA $7E2010, X
                                                   STA $7E201C, X
