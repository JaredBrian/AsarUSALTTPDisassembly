...
; All palette locations according to HM
...
; $DD630, $DD648, $DD308, $DE6C8, $DD218, $DE86C, $DE604, $DD4E0
; $DD734, $DD660, $55B27, $DD39E, $DD446, $DE544, $64425, $F4CD3
