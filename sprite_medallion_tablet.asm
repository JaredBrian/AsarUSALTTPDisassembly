...
Sprite_MedallionTablet:
{
    ...
    dw MedallionTablet_Main ; 0x00 - $F30C
    dw Sprite_DustCloud     ; 0x01 - $F2B2
}

; ==============================================================================

; $02F2A9-$02F2B1 DATA
Sprite_DustCloud_animation_states:
{
...
MedallionTablet_Main:
{
    ...
    LDA.w $0D80, X
    JSL.l UseImplicitRegIndexedLocalJumpTable
    dw MedallionTablet_WaitForMudoraReader ; 0x00 - $F34F
    dw MedallionTablet_ExtendedDelay       ; 0x01 - $F42E
    dw MedallionTablet_Crumbling           ; 0x02 - $F43C
    dw MedallionTablet_FinalAnimationState ; 0x03 - $F463
}
            ...
            JSR.w Sprite2_DirectionToFacePlayer : CPY.b #$02 : BNE .beta
                ...
                LDA.w $0FDA : CLC : ADC.w #$0010 : CMP $20 : SEP #$30 : BCC .beta
                    LDA.b $F4 : BPL .gamma
                        ...
                        ; sword and the book of Mudora and the Master Sword are
                        ; used at the same time, the Master Sword wins, but the
                        ; Tempered and Golden swords never hit this case? Does
                        ; this suggest that this code was written before the
                        ; Tempered and Master Swords were even conceived of
                        ; Even so, what is the real intention of this logic? By
                        ; the way, this has been verified to prevent one from
                        ; getting the medallion with the Master Sword and to
                        ; not prevent with the Golden Sword. It's difficult to
                        ; test because the button presses have to come in on
                        ; exactly the same frame, though.
