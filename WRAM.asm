...
struct WRAM $7E0000
{
    ...
    ; $012E[0x01] -   (Sound)
        ...
        ; 0x21:   sounds like a plop on wood, can't remember where it gets used   ; link landing sound/ boss stepping sound
        ...
        ; 0x32:   sounds familiar but can't place it. Whooshing noise     ; bug net swing
    ...
    ; $0223[0x01] -   (????)
        ; There's a few STZ.w $0223's that pop up in the rom but other than that it's
        ; not clear if it was ever intended to be used for anything.

    ; $0224[0x0C] -   Free RAM? -  Nope! causes some funky faded effects and a lack of an overworld.
    ...
    ; $02D9[0x01] -   
        ; Related to $02D8, haven't worked out the details because it wasn't necessary yet.
    ...
    ; $040C[0x02] -   (Dungeon)
        ; Dungeon ID / Dungeon index. If it's equal to 0xFF, that means there is no map
        ; for that area.
    ...
    ; $0700[0x02] -   Generally is equal to the area number you are in currently in 
    ...
    ; $0708[0x02] -   ???? I'm too lazy to document these 4 values, but essentially 
    ; $070A[0x02] -   ???? they're masks that determinethe size of each overworld 
    ; $070C[0x02] -   ???? "block"
    ; $070E[0x02] -   ????
    ...
    ; $0716[0x01] -   Forms right and bottom bounding value for where scroll
    ...
    ; $0CF3[0x01] -   Free RAM TODO: actually not? A comment in bank 06 seems to
        ;     suggest otherwise.
    ...
    ; $0D00[0x10] -   The lower byte of a sprite's Y - coordinate. ; functions
    ; $0D10[0x10] -   The lower byte of a sprite's X - coordinate. ; functions
    ; $0D20[0x10] -   The high byte of a sprite's Y - coordinate. ; functions
    ; $0D30[0x10] -   The high byte of a sprite's X - coordinate. ; functions
    ...
    ; $0D60[0x10] -   Y "second derivative" to give a path a more rounded shape when needed. ; sprite
    ; $0D70[0x10] -   X "second derivative" to give a path a more rounded shape when needed. ; sprite

    ; $0D80[0x10] -   Controls whether the sprite has been spawned yet. 0 - no. Not 0 - yes. Also used as an AI pointer ; functions
    ...
    ; $0FBF[0x01] -   Holds base upper byte of current overworld area's coordinates
        ...
        ;     
    ; $0FC0[0x01] -   Free RAM - RESERVED BY ZS used to keep track of which animated tile GFX set is currently being used.
    ...
    ; $7EC10C[0x02] - Mirror of $8A ; is this wrong? I don't ever see it changing.
    ...
    ; $7EC213[0x02] - Mirror of $8A ; Only written to when exiting a dungeon
