...
Sprite_DashBeeHive:
{
    ...
    dw DashBeeHive_WaitForDash ; 0x00 - $DC68
    dw Bee_Normal              ; 0x01 - $DD45
    dw Bee_PutInbottle         ; 0x02 - $DDF1
}
...
; $0F5C8F-$0F5C9A LOCAL JUMP LOCATION
DashBeeHive_SpawnBee:
{
    LDA.b #$79
    JSL.l Sprite_SpawnDynamically : BMI DashBeeHive_InitBee_spawn_failed
        JSL.l Sprite_SetSpawnedCoords

        ; Bleeds into the next function.
}

; $0F5C9B-$0F5CCE LOCAL JUMP LOCATION
DashBeeHive_InitBee:
{
    PHX
...
Sprite_GoodBee:
{
    LDA.w $0D80, X
    JSL.l UseImplicitRegIndexedLocalJumpTable
    dw GoodBee_WaitingForDash ; 0x00 - $DE70
    dw GoodBee_Activated      ; 0x01 - $DED2
    dw Bee_PutInbottle        ; 0x02 - $DDF1
}
...
GoodBee_Activated:
{
    ...
    ; OPTIMIZE: Unless we can find an instance of this variable changing
