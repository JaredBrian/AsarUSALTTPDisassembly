...
SpritePrep_BubbleGroup:
{
    ...
    LDA.l .y_speeds, X : STA.w $0D40, Y
    
    LDA.l .x_polarities, X : STA.w $0D90, Y
    
    LDA.l .y_polarities, X : STA.w $0DA0, Y
...
Sprite_BubbleGroup:
{
    ...
    LDA.w $0D50, X : CLC : ADC .speed_step, Y : STA.w $0D50, X
    ...
    LDA.w $0D40, X : CLC : ADC .speed_step, Y : STA.w $0D40, X
