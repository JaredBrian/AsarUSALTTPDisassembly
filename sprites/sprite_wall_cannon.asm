...
Sprite_WallCannon:
{
    ...
    LDA .cannon_animation_states, Y : ADC.b #$00 : STA.w $0DC0, X
    ...
    LDA .cannon_x_speeds, Y : STA.w $0D50, X
    
    LDA .cannon_y_speeds, Y : STA.w $0D40, X
    ...
    LDA .cannonball_y_speeds, X : STA.w $0D40, Y
