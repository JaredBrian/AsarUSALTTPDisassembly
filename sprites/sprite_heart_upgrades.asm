...
HeartUpgrade_SetOutdoorAcquiredFlag:
{     
    PHX
...
Sprite_HeartPiece:
{
    ...
    JSL.l Sprite_CheckIfPlayerPreoccupied : BCS .return
        ...
        LDA.w $0E70, X : AND.b #$03 : BEQ .no_horiz_tile_collision
            ...
            ; After testing, it was apparent that if one sets the vertical
            ; velocity, nothing will attempt to stop the heart piece from
