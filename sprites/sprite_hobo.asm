...
Sprite_HoboEntities:
{
    ...
    dw Sprite_Hobo       ; 0x00 - $BDD0
    dw Sprite_HoboBubble ; 0x01 - $BEB4
    dw Sprite_HoboFire   ; 0x02 - $BF15
    dw Sprite_HoboSmoke  ; 0x03 - $BF81
}
...
Sprite_Hobo:
{
    ...
    LDA.w $0D80, X
    JSL.l UseImplicitRegIndexedLocalJumpTable
    dw Hobo_Sleeping    ; 0x00 - $BDFA
    dw Hobo_WakeUp      ; 0x01 - $BE39
    dw Hobo_GrantBottle ; 0x02 - $BE5F
    dw Hobo_BackToSleep ; 0x03 - $BE89
}
...
Hobo_WakeUp:
{
    LDA.w $0DF0, X : BNE .delay
        ...
        LDA.w Pool_Hobo_WakeUp_animation_states, Y : BMI .invalid_state
            ...
            LDA.w Pool_Hobo_WakeUp_timers, Y : STA.w $0DF0, X
...
; $033EED-$033F0E LOCAL JUMP LOCATION
Hobo_SpawnBubble:
{
    ; Spawn the sleep bubble hanging out of the hobo's nose?
    LDA.b #$2B
    
    JSL.l Sprite_SpawnDynamically : BMI Sprite_ZeroOamAllocation_spawn_failed
        JSL.l Sprite_SetSpawnedCoords
