...
; $0F4B8B-$0F4B96 DATA
Pool_Sprite_AntiFairyGroup:
{
    ; Not really sure what this would be for. perhaps earlier draft
...
Sprite_AntiFairyGroup:
{
    ...
    LDA.w $0D50, X : CLC : ADC.w Pool_Sprite_AntiFairyGroup_speed_step, Y : STA.w $0D50, X
    CMP.w Pool_Sprite_AntiFairyGroup_speed_limit, Y : BNE .dont_flip _x_speed_polarity
        INC.w $0D90, X
    
    .dont_flip_x_speed_polarity
    
    LDA.w $0DA0, X : AND.b #$01 : TAY
    LDA.w $0D40, X : CLC : ADC.w Pool_Sprite_AntiFairyGroup_speed_step, Y : STA.w $0D40, X
