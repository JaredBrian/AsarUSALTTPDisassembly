...
Ancilla_BreakTowerSeal:
{
    ...
    LDA.w $0C54, X : CMP.b #$01 : BNE .not_first_expansion
        LDA.b $11 : BNE .expansion_delay
            LDA.b #$10 : STA.w $0C2C, X
            
            LDA.w $0C04, X : STA.b $72
            LDA.w $0C18, X : STA.b $73
            ...
            LDA.b $72 : STA.w $0C04, X
            LDA.b $73 : STA.w $0C18, X
    ...
    LDA.b $11 : BNE .move_and_draw_crystals
    ...
    .handle_next_crystal
        ...
        LDA.b $11 : BNE .dont_increment_angle
            ; When initially expanding the first 6 crystals out from the center
            ; one, don't rotate them.
            LDA.b $72 : CMP.b #$01 : BEQ .dont_increment_angle
                LDA.b $1A : AND.b #$01 : BNE .dont_increment_angle
        ...
        CLC : ADC.l $7F5810 : CLC : ADC.w #$FFF8 : SEC : SBC.w $0122 : STA.b $00
        ...
        CLC : ADC.l $7F580E : CLC : ADC.w #$FFF8 : SEC : SBC.w $011E : STA.b $02
        
        PLY
        
        SEP #$20
        
        LDA.b $00 : STA.l $7F5817, X
        LDA.b $01 : STA.l $7F581F, X
        
        LDA.b $02 : STA.l $7F5827, X
        LDA.b $03 : STA.l $7F582F, X
    ...
    LDA.b $00 : STA.l $7F581E
    LDA.b $01 : STA.l $7F5826
    
    LDA.b $02 : STA.l $7F582E
    LDA.b $03 : STA.l $7F5836
...
BreakTowerSeal_ActivateSingleSparkle:
{
    ...
    TXA : AND.b #$07 : TAX
    LDA.l $7F5817, X : CLC : ADC.b $08  : STA.b $00
    LDA.l $7F581F, X       : ADC.b #$00 : STA.b $01
    
    LDA.l $7F5827, X : CLC : ADC.b $09  : STA.b $02
    LDA.l $7F582F, X       : ADC.b #$00 : STA.b $03
    
    PLX
    
    ; Set Y coordinate.
    LDA.b $00 : STA.l $7F584F, X
    LDA.b $01 : STA.l $7F5867, X
    
    ; Set X coordinate.
    LDA.b $02 : STA.l $7F587F, X
    LDA.b $03 : STA.l $7F5897, X
...
BreakTowerSeal_ExecuteSparkles:
{
    ...
    .check_next_sparkle
        ...
        LDA.l $7F5837, X : CMP.b #$FF : BEQ .inactive_sparkle
            LDA.l $7F58AF, X : DEC : STA.l $7F58AF, X
            BPL .still_active
                LDA.b #$04 : STA.l $7F58AF, X
                
                LDA.l $7F5837, X : INC : STA.l $7F5837, X
                CMP.b #$03 : BNE .still_active
            ...
            LDA.l $7F584F, X : STA.b $00
            LDA.l $7F5867, X : STA.b $01
            
            ; Form 16-bit X coordinate.
            LDA.l $7F587F, X : STA.b $02
            LDA.l $7F5897, X : STA.b $03
