...
Death_PrepFaint:
{
    ...
    ; \item
    LDA.b #$06 : CMP $7EF35C : BEQ .bottledFairy
                 CMP $7EF35D : BEQ .bottledFairy
                 CMP $7EF35E : BEQ .bottledFairy
                 CMP $7EF35F : BEQ .bottledFairy
    
    STZ $05FC : STZ $05FD ; This is hit if we do not have any bottled fairies
